...
public class VentanaPaint extends javax.swing.JFrame {
    ...
    private void jPanel1MouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseDragged
        ...
        switch (herramientas1.formaElegida) {
            ...
            case 3:
                ...
                break;
            case 4:
                miRectangulo.dibujate(bufferGraphics, evt.getX(), evt.getY(), grosor);
                break;
            case 5:
                miForma.dibujate(bufferGraphics, evt.getX(), evt.getY(), grosor);
                break;
    ...
    private void jPanel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MousePressed
        switch (herramientas1.formaElegida) {
            ...
            case 3:
                ...
                break;
            case 4:
                miRectangulo = new Rectangulo(evt.getX(), evt.getY(), panelColores1.colorSeleccionado, herramientas1.relleno);
                miForma.dibujate(bufferGraphics, evt.getX(), evt.getY(), grosor);
                break;
            case 5:
    ...
    private void jPanel1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseReleased
        switch (herramientas1.formaElegida) {
            ...
            case 3:
                ...
                break;
            case 4:
                miRectangulo.dibujate(bufferGraphics2, evt.getX(), evt.getY(), grosor);
                break;
            case 5:
                miForma.dibujate(bufferGraphics2, evt.getX(), evt.getY(), grosor);
                break;
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        if (retroceso.size() == 2) {
            bufferGraphics.drawImage(retroceso.get(retroceso.size() - 1), 0, 0, null);
        } else if (retroceso.size() > 2) {
